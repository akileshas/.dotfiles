...
alias lt="eza --icons=always --color=always --group-directories-first --long --ignore-glob node_modules --git --no-permissions --no-filesize --no-user --no-time --tree"
alias ltl="eza --icons=always --color=always --group-directories-first --all --long --ignore-glob .git --ignore-glob node_modules --git --no-permissions --no-filesize --no-user --no-time --tree"
