...
. "$HOME/.cargo/env"
[ -f "/home/akileshas/.ghcup/env" ] && . "/home/akileshas/.ghcup/env" # ghcup-env
...
if type z | grep -q 'function'; then
    eval "$(declare -f z | sed '1s/z/orig_z/')"
fi
...
source "$HOME/dev/env/lib/tmux.sh"
source "$HOME/dev/env/lib/conda.sh"
